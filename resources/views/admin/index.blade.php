                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary">
                            <div class="inner">
                                ...
                                <h3>{{ number_format($total_client_collection, 2) }} TK</h3>
                            </div>
                            <div class="icon">
                                <i class="ion ion-bag"></i>
                            </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <p>Total Due</p>
                                <h3>{{ number_format($due_amount, 2) }} TK</h3>
                            </div>
                            <div class="icon">
                                <i class="ion ion-bag"></i>
                            </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner text-white">
                                ...
                                <h3>{{ number_format($today_sales, 2) }} TK</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                ...
                                <h3>{{ number_format($today_collection, 2) }} TK</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner text-white">
                                <p>Total Sales</p>
                                <h3>{{ number_format($total_sales, 2) }} TK</h3>
        ...
        function customerLeader(custID) {
            $.ajax({
                ...
                $('#total_due').text(res.total_due < 0 ? '(' + Math.abs(parseFloat(res.total_due).toFixed(
                    2)) + ')' : parseFloat(res.total_due).toFixed(2));
